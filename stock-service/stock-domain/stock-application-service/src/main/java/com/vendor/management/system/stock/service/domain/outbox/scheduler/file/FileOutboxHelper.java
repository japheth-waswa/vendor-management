...
@Slf4j
@Component
public class FileOutboxHelper extends OutboxHelper<OrderFileOutboxRepository, OrderOutboxMessage, OrderEventPayload> {

    public FileOutboxHelper(OrderFileOutboxRepository outboxRepository, ObjectMapper objectMapper) {

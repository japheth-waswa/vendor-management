 ...
 */
package debezium.stock.order_outbox;
...
public class Envelope extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private debezium.stock.order_outbox.Value before;
  private debezium.stock.order_outbox.Value after;
   ...
   */
  public Envelope(debezium.stock.order_outbox.Value before, debezium.stock.order_outbox.Value after, io.debezium.connector.postgresql.Source source, java.lang.String op, java.lang.Long ts_ms, event.block transaction) {
    this.before = before;
    this.after = after;
    this.source = source;
    this.op = op;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: before = (debezium.stock.order_outbox.Value)value$; break;
    case 1: after = (debezium.stock.order_outbox.Value)value$; break;
   ...
   */
  public debezium.stock.order_outbox.Value getBefore() {
    return before;
  }
   ...
   */
  public void setBefore(debezium.stock.order_outbox.Value value) {
    this.before = value;
  }
   ...
   */
  public debezium.stock.order_outbox.Value getAfter() {
    return after;
  }
   ...
   * @param value the value to set.
   */
  public void setAfter(debezium.stock.order_outbox.Value value) {
    this.after = value;
  }
   ...
   */
  public static debezium.stock.order_outbox.Envelope.Builder newBuilder() {
    return new debezium.stock.order_outbox.Envelope.Builder();
  }
   ...
   * @return A new Envelope RecordBuilder
   */
  public static debezium.stock.order_outbox.Envelope.Builder newBuilder(debezium.stock.order_outbox.Envelope.Builder other) {
    if (other == null) {
      return new debezium.stock.order_outbox.Envelope.Builder();
    } else {
      return new debezium.stock.order_outbox.Envelope.Builder(other);
    }
  }
   ...
   * @return A new Envelope RecordBuilder
   */
  public static debezium.stock.order_outbox.Envelope.Builder newBuilder(debezium.stock.order_outbox.Envelope other) {
    if (other == null) {
      return new debezium.stock.order_outbox.Envelope.Builder();
    } else {
      return new debezium.stock.order_outbox.Envelope.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Envelope>
    ...
    private debezium.stock.order_outbox.Value before;
    private debezium.stock.order_outbox.Value.Builder beforeBuilder;
    private debezium.stock.order_outbox.Value after;
    private debezium.stock.order_outbox.Value.Builder afterBuilder;
    private io.debezium.connector.postgresql.Source source;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(debezium.stock.order_outbox.Envelope.Builder other) {
      super(other);
      ...
      if (other.hasBeforeBuilder()) {
        this.beforeBuilder = debezium.stock.order_outbox.Value.newBuilder(other.getBeforeBuilder());
      }
      ...
      if (other.hasAfterBuilder()) {
        this.afterBuilder = debezium.stock.order_outbox.Value.newBuilder(other.getAfterBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(debezium.stock.order_outbox.Envelope other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.before)) {
        this.before = data().deepCopy(fields()[0].schema(), other.before);
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.stock.order_outbox.Envelope.Builder setBefore(debezium.stock.order_outbox.Value value) {
     ...
     * @return This builder.
     */
    public debezium.stock.order_outbox.Value.Builder getBeforeBuilder() {
      if (beforeBuilder == null) {
        if (hasBefore()) {
          setBeforeBuilder(debezium.stock.order_outbox.Value.newBuilder(before));
        } else {
          setBeforeBuilder(debezium.stock.order_outbox.Value.newBuilder());
        }
      }
    ...
    public debezium.stock.order_outbox.Envelope.Builder setBeforeBuilder(debezium.stock.order_outbox.Value.Builder value) {
      clearBefore();
      beforeBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.stock.order_outbox.Envelope.Builder clearBefore() {
      before = null;
      beforeBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.stock.order_outbox.Envelope.Builder setAfter(debezium.stock.order_outbox.Value value) {
     ...
     * @return This builder.
     */
    public debezium.stock.order_outbox.Value.Builder getAfterBuilder() {
      if (afterBuilder == null) {
        if (hasAfter()) {
          setAfterBuilder(debezium.stock.order_outbox.Value.newBuilder(after));
        } else {
          setAfterBuilder(debezium.stock.order_outbox.Value.newBuilder());
        }
      }
      return afterBuilder;
    }
    ...
    public debezium.stock.order_outbox.Envelope.Builder setAfterBuilder(debezium.stock.order_outbox.Value.Builder value) {
      clearAfter();
      afterBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.stock.order_outbox.Envelope.Builder clearAfter() {
      after = null;
      afterBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.stock.order_outbox.Envelope.Builder setSource(io.debezium.connector.postgresql.Source value) {
    ...
    public debezium.stock.order_outbox.Envelope.Builder setSourceBuilder(io.debezium.connector.postgresql.Source.Builder value) {
      clearSource();
      sourceBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.stock.order_outbox.Envelope.Builder clearSource() {
      source = null;
      sourceBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.stock.order_outbox.Envelope.Builder setOp(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.stock.order_outbox.Envelope.Builder clearOp() {
      op = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.stock.order_outbox.Envelope.Builder setTsMs(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.stock.order_outbox.Envelope.Builder clearTsMs() {
      ts_ms = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.stock.order_outbox.Envelope.Builder setTransaction(event.block value) {
    ...
    public debezium.stock.order_outbox.Envelope.Builder setTransactionBuilder(event.block.Builder value) {
      clearTransaction();
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.stock.order_outbox.Envelope.Builder clearTransaction() {
      transaction = null;
    ...
    public Envelope build() {
      try {
        ...
        if (beforeBuilder != null) {
          ...
          record.before = fieldSetFlags()[0] ? this.before : (debezium.stock.order_outbox.Value) defaultValue(fields()[0]);
        }
        if (afterBuilder != null) {
          try {
          ...
          record.after = fieldSetFlags()[1] ? this.after : (debezium.stock.order_outbox.Value) defaultValue(fields()[1]);
        }
        if (sourceBuilder != null) {
          try {
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      if (in.readIndex() != 1) {
        ...
        if (this.before == null) {
          this.before = new debezium.stock.order_outbox.Value();
        }
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.after == null) {
          this.after = new debezium.stock.order_outbox.Value();
        }
